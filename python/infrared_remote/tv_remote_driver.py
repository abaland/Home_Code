"""
This driver takes cares of storing information about and sending infrared signals to control my tv 
    remote.
...
Follows data bits where each 1 is (High, Low) of (430, 1250) and each 0 is (High, Low) of (430, 410)
